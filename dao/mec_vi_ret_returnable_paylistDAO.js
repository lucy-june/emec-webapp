...
var model= require('../model/mec_vi_ret_returnable_paylist.json');
var table = sequelize.define('mec_vi_ret_returnable_paylist',model,{freezeTableName:true,createdAt:false,updatedAt:false});
