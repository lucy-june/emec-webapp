...
var model= require('../model/mec_vi_order_counter_userbuy.json');
var table = sequelize.define('mec_vi_order_counter_userbuy',model,{freezeTableName:true,createdAt:false,updatedAt:false});
