...
var model= require('../model/mec_vi_package_item_raw.json');
var table = sequelize.define('mec_vi_package_item_raw',model,{freezeTableName:true,createdAt:false,updatedAt:false});
