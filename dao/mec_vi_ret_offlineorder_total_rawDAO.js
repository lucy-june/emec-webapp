...
var model= require('../model/mec_vi_ret_offlineorder_total_raw.json');
var table = sequelize.define('mec_vi_ret_offlineorder_total_raw',model,{freezeTableName:true,createdAt:false,updatedAt:false});
