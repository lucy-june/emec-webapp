...
var model= require('../model/mec_vi_ret_returnable_contentinfo.json');
var table = sequelize.define('mec_vi_ret_returnable_contentinfo',model,{freezeTableName:true,createdAt:false,updatedAt:false});
