...
var model= require('../model/mec_vi_offline_order_total.json');
var table = sequelize.define('mec_vi_offline_order_total',model,{freezeTableName:true,createdAt:false,updatedAt:false});
