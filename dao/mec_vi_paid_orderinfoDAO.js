...
var model= require('../model/mec_vi_paid_orderinfo.json');
var table = sequelize.define('mec_vi_paid_orderinfo',model,{freezeTableName:true,createdAt:false,updatedAt:false});
