...
var model= require('../model/mec_vi_ret_returnable_paylist_raw.json');
var table = sequelize.define('mec_vi_ret_returnable_paylist_raw',model,{freezeTableName:true,createdAt:false,updatedAt:false});
