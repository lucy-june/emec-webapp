...
var model= require('../model/mec_vi_package_item_total.json');
var table = sequelize.define('mec_vi_package_item_total',model,{freezeTableName:true,createdAt:false,updatedAt:false});
