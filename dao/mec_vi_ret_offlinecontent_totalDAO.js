...
var model= require('../model/mec_vi_ret_offlinecontent_total.json');
var table = sequelize.define('mec_vi_ret_offlinecontent_total',model,{freezeTableName:true,createdAt:false,updatedAt:false});
