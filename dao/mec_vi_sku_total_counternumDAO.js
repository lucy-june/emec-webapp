...
var model= require('../model/mec_vi_sku_total_counternum.json');
var table = sequelize.define('mec_vi_sku_total_counternum',model,{freezeTableName:true,createdAt:false,updatedAt:false});
