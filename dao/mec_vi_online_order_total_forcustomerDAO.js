...
var model= require('../model/mec_vi_online_order_total_forcustomer.json');
var table = sequelize.define('mec_vi_online_order_total_forcustomer',model,{freezeTableName:true,createdAt:false,updatedAt:false});
