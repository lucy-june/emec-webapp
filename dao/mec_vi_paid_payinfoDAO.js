...
var model= require('../model/mec_vi_paid_payinfo.json');
var table = sequelize.define('mec_vi_paid_payinfo',model,{freezeTableName:true,createdAt:false,updatedAt:false});
