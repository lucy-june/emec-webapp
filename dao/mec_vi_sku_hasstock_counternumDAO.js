...
var model= require('../model/mec_vi_sku_hasstock_counternum.json');
var table = sequelize.define('mec_vi_sku_hasstock_counternum',model,{freezeTableName:true,createdAt:false,updatedAt:false});
