...
var model= require('../model/mec_vi_deletable_rule.json');
var table = sequelize.define('mec_vi_deletable_rule',model,{freezeTableName:true,createdAt:false,updatedAt:false});
