...
var model= require('../model/mec_vi_online_order_total_forassistant.json');
var table = sequelize.define('mec_vi_online_order_total_forassistant',model,{freezeTableName:true,createdAt:false,updatedAt:false});
