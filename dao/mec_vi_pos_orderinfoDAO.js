...
var model= require('../model/mec_vi_pos_orderinfo.json');
var table = sequelize.define('mec_vi_pos_orderinfo',model,{freezeTableName:true,createdAt:false,updatedAt:false});
