...
var model= require('../model/mec_vi_package_item.json');
var table = sequelize.define('mec_vi_package_item',model,{freezeTableName:true,createdAt:false,updatedAt:false});
