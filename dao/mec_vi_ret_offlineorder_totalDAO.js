...
var model= require('../model/mec_vi_ret_offlineorder_total.json');
var table = sequelize.define('mec_vi_ret_offlineorder_total',model,{freezeTableName:true,createdAt:false,updatedAt:false});
