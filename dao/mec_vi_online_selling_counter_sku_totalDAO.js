...
var model= require('../model/mec_vi_online_selling_counter_sku_total.json');
var table = sequelize.define('mec_vi_online_selling_counter_sku_total',model,{freezeTableName:true,createdAt:false,updatedAt:false});
