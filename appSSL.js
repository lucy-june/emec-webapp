...
var app_brand    = require('./routes/app/brand');
...
var app_promotion   = require('./routes/app/promotion');
...
app.use('/app/promotion', app_promotion);
app.use('/app/logistics', app_logistics);
app.use('/app/behavior', app_behavior);
app.use('/app/umspay', app_umspay);
app.use('/app/vip', app_vip);
